...
function Regester() {
    const schema = z.object({
        email: z
          ...
          .max(280, "email must be less than 280 characters"),
         name: z
          .string()
          .min(1, "name is required")
          .max(10, "name must be less than 280 characters"),
         lastname: z
          .string()
          .min(1, "lastname is required")
          .max(10, "lastname must be less than 280 characters"),
          password:z.string()
  ...
  <div className="mt-4">
                ...
                <input  {...register("name")} className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" />
            </div>
            <div className="mt-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Lastname</label>
                <input  {...register("lastname")} className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" />
            </div>
  </div>
            ...
            <div className="mt-8">
                <button type="submit" className="bg-primary text-white font-bold py-2 px-4 w-full rounded hover:bg-black">Regester</button>
            </div>
        </form>
